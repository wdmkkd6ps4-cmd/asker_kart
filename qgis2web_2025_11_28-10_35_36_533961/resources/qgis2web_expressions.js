...
function exp_TilAskersentrummorgen_1rule0_eval_expression(context) {
    // mode = 'tog'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('mode')  == 'tog');
    } else {
        return (feature.get('mode')  == 'tog');
    }
}
...
function exp_TilAskersentrummorgen_1rule1_eval_expression(context) {
    // mode = 'bil'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('mode')  == 'bil');
    } else {
        return (feature.get('mode')  == 'bil');
    }
}
...
function exp_TilAskersentrummorgen_1rule2_eval_expression(context) {
    // mode = 'buss'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('mode')  == 'buss');
    } else {
        return (feature.get('mode')  == 'buss');
    }
}
...
function exp_TilAskersentrummorgen_1rule3_eval_expression(context) {
    // mode = 'sykkel'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('mode')  == 'sykkel');
    } else {
        return (feature.get('mode')  == 'sykkel');
    }
}